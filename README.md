# Dijkstra-Navigation-Program [내비게이션 프로그램 설계]
### 1. 과제 개요  
...
### 3. 수행할 기능  
  #### (1) 데이터 입력받기  
     프로그램을 실행하면 무향그래프(undirected graph) 정보를 표준입력(standard input)으로 입력받아, <br/>인접리스트 기반(adjacency list representation) 그래프자료구조를 생성하여 관리한다.  
